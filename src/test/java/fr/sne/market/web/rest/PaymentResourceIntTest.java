...
import fr.sne.market.repository.PaymentRepository;
import fr.sne.market.repository.search.PaymentSearchRepository;
import fr.sne.market.service.dto.PaymentDTO;
import fr.sne.market.service.mapper.PaymentMapper;
...
public class PaymentResourceIntTest {
    ...
    private static final Boolean DEFAULT_ALLOWED = false;
    private static final Boolean UPDATED_ALLOWED = true;

    private static final PaymentType DEFAULT_PAYMENT_TYPE = PaymentType.CREDITCARD;
    private static final PaymentType UPDATED_PAYMENT_TYPE = PaymentType.MOBILE;
    ...
    public void setup() {
        ...
        PaymentResource paymentResource = new PaymentResource(paymentRepository, paymentMapper, paymentSearchRepository);
    ...
    public void createPayment() throws Exception {
        ...
        assertThat(testPayment.isAllowed()).isEqualTo(DEFAULT_ALLOWED);
    ...
    public void getAllPayments() throws Exception {
        ...
        restPaymentMockMvc.perform(get("/api/payments?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].allowed").value(hasItem(DEFAULT_ALLOWED.booleanValue())))
    ...
    public void getPayment() throws Exception {
        ...
        restPaymentMockMvc.perform(get("/api/payments/{id}", payment.getId()))
            ...
            .andExpect(jsonPath("$.allowed").value(DEFAULT_ALLOWED.booleanValue()))
    ...
    public void updatePayment() throws Exception {
        ...
        assertThat(testPayment.isAllowed()).isEqualTo(UPDATED_ALLOWED);
