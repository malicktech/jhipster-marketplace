...
import fr.sne.market.domain.Country;
import fr.sne.market.repository.CountryRepository;
import fr.sne.market.repository.search.CountrySearchRepository;
import fr.sne.market.service.dto.CountryDTO;
import fr.sne.market.service.mapper.CountryMapper;
...
public class CountryResourceIntTest {
    ...
    public void setup() {
        ...
        CountryResource countryResource = new CountryResource(countryRepository, countryMapper, countrySearchRepository);
