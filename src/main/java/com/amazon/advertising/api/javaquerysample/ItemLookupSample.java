...
package com.amazon.advertising.api.javaquerysample;
...
public class ItemLookupSample {
    ...
    /*
     * The Item ID to lookup. The value below was selected for the FR locale.
     * You can choose a different value if this value does not work in the
     * locale of your choice.
     * 
     * ASIN : 2893775470
     * https://www.amazon.fr/D%C3%A9velopper-Mysql-Javascript-Jquery-Html5/dp/2893775470?SubscriptionId=AKIAJ5XZFNFFPAGZEDFQ&tag=daktic-21&linkCode=xm2&camp=2025&creative=165953&creativeASIN=2893775470
     */
    private static final String ITEM_ID = "2893775470";
    ...
    public static void main(String[] args) {
        ...
        params.put("Version", "2013-08-01"); // not required         
...
//        title = ResponseUtility.fetchTitle(requestUrl);
