    ...
    extends Service
{
    ...
    private final static Logger logger = Logger.getLogger(com.amazon.advertising.api.ECS.client.jax.AWSECommerceService.class.getName());

    static {
        URL url = null;
        try {
            URL baseUrl;
            baseUrl = com.amazon.advertising.api.ECS.client.jax.AWSECommerceService.class.getResource(".");
