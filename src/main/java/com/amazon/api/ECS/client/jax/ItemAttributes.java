    ...
    implements Serializable
{
    ...
    public ItemAttributes.CatalogNumberList catalogNumberList;
    ...
    public List<ItemAttributes.Creator> creator;
    ...
    public ItemAttributes.EANList eanList;
    ...
    public ItemAttributes.Languages languages;
    ...
    public ItemAttributes.UPCList upcList;
        ...
        implements Serializable
    {
        ...
        public List<ItemAttributes.Languages.Language> language;
	...
	public String toString() {
		return "ItemAttributes [actor=" + actor + ", artist=" + artist + ", aspectRatio=" + aspectRatio
				+ ", audienceRating=" + audienceRating + ", audioFormat=" + audioFormat + ", author=" + author
				+ ", binding=" + binding + ", brand=" + brand + ", catalogNumberList=" + catalogNumberList
				+ ", category=" + category + ", ceroAgeRating=" + ceroAgeRating + ", clothingSize=" + clothingSize
				+ ", color=" + color + ", creator=" + creator + ", department=" + department + ", director=" + director
				+ ", ean=" + ean + ", eanList=" + eanList + ", edition=" + edition + ", eisbn=" + eisbn
				+ ", episodeSequence=" + episodeSequence + ", esrbAgeRating=" + esrbAgeRating + ", feature=" + feature
				+ ", format=" + format + ", genre=" + genre + ", hardwarePlatform=" + hardwarePlatform
				+ ", hazardousMaterialType=" + hazardousMaterialType + ", isAdultProduct=" + isAdultProduct
				+ ", isAutographed=" + isAutographed + ", isbn=" + isbn + ", isEligibleForTradeIn="
				+ isEligibleForTradeIn + ", isMemorabilia=" + isMemorabilia + ", issuesPerYear=" + issuesPerYear
				+ ", itemDimensions=" + itemDimensions + ", itemPartNumber=" + itemPartNumber + ", label=" + label
				+ ", languages=" + languages + ", legalDisclaimer=" + legalDisclaimer + ", listPrice=" + listPrice
				+ ", magazineType=" + magazineType + ", manufacturer=" + manufacturer + ", manufacturerMaximumAge="
				+ manufacturerMaximumAge + ", manufacturerMinimumAge=" + manufacturerMinimumAge
				+ ", manufacturerPartsWarrantyDescription=" + manufacturerPartsWarrantyDescription + ", mediaType="
				+ mediaType + ", model=" + model + ", modelYear=" + modelYear + ", mpn=" + mpn + ", numberOfDiscs="
				+ numberOfDiscs + ", numberOfIssues=" + numberOfIssues + ", numberOfItems=" + numberOfItems
				+ ", numberOfPages=" + numberOfPages + ", numberOfTracks=" + numberOfTracks + ", operatingSystem="
				+ operatingSystem + ", packageDimensions=" + packageDimensions + ", packageQuantity=" + packageQuantity
				+ ", partNumber=" + partNumber + ", pictureFormat=" + pictureFormat + ", platform=" + platform
				+ ", productGroup=" + productGroup + ", productTypeName=" + productTypeName
				+ ", productTypeSubcategory=" + productTypeSubcategory + ", publicationDate=" + publicationDate
				+ ", publisher=" + publisher + ", regionCode=" + regionCode + ", releaseDate=" + releaseDate
				+ ", runningTime=" + runningTime + ", seikodoProductCode=" + seikodoProductCode + ", size=" + size
				+ ", sku=" + sku + ", studio=" + studio + ", subscriptionLength=" + subscriptionLength + ", title="
				+ title + ", trackSequence=" + trackSequence + ", tradeInValue=" + tradeInValue + ", upc=" + upc
				+ ", upcList=" + upcList + ", warranty=" + warranty + ", weeeTaxValue=" + weeeTaxValue + "]";
	}
