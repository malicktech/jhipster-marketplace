...
currentAccount: any;
    ...
    loadAll() {
        if (this.currentSearch) {
            this.marketOrdersService.search({
    ...
    transition() {
        this.router.navigate(['/market-orders'], {queryParams:
            {
                page: this.page,
                size: this.itemsPerPage,
    ...
    trackId(index: number, item: MarketOrders) {
        return item.id;
    }
    registerChangeInMarketOrders() {
        this.eventSubscriber = this.eventManager.subscribe('marketOrdersListModification', (response) => this.loadAll());
    }
